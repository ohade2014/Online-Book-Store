...
public abstract class MicroService implements Runnable {
    ...
    private ServicesInitCounter initCounter = ServicesInitCounter.getInstance();
    ...
    public final void run() {
        //Initial this Micro-Service
        MB.register(this);
        initialize();
        initCounter.Plusplus(); //Count this MicroService as activated
        while (!terminated) {
            try{
                // Wait for message get in the queue and activate its callback
